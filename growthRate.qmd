...
## could you do the same re-organisation of plots that you did in local estimates? I.e., first Hadeland, then Oslo, then Ringerike? Skip Gudbrandsdalen, Mjøsa and Valdres here, as we have no data. 
## Here Nordre Ultvet is included, so nothing wrong with data then (ref. comment in localEst)
...
#plot_logR(local_list[27])
#plot_logR(local_list[28])
#plot_logR(local_list[29])
