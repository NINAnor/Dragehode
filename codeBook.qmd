---
title: "Code to recreate the analysis"
editor: visual
lang: no
---
...
library(rio)
library(Dragehode)
#Sys.setlocale(locale = 'Norwegian Bokmål_Norway') # Uncomment this line if you locale is not Norway
...
plot.gruppetrender(lokalitetsdata,gruppevariabel="Region",lokalitetsestimater,tidsrom=tidsrom,reverser=T,lokalitetsnavn,lokfarge,regsymbol,natlinje)
par(mfrow=c(1,3))
...
plot.gruppetrender(lokalitetsdata,gruppevariabel="Hovednaturtype",lokalitetsestimater,tidsrom=tidsrom,reverser=T,lokalitetsnavn,lokfarge,regsymbol,natlinje)
par(mfrow=c(1,3))
plot(0,0,type="n",axes=F,xlab="",ylab=""); legend("topleft",lty=1,col=lokfarge,legend=lokalitetsnavn,bty="n")
dev.off()
...
plot.gruppetrender(lokalitetsdata,gruppevariabel="Hovedskjøtsel",lokalitetsestimater,tidsrom=tidsrom,reverser=T,lokalitetsnavn,lokfarge,regsymbol,natlinje)
par(mfrow=c(1,3))
plot(0,0,type="n",axes=F,xlab="",ylab=""); legend("topleft",lty=1,col=lokfarge,legend=lokalitetsnavn,bty="n")
dev.off()

## GGplot versions of figures¨
source("R/ggplot_popstruktur.R")
