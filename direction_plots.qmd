...
Figurene presentert her viser sannsynligheten for at en populasjon er i √∏kning, nedgang eller stabil. Vi vurderte usikkerheten i retningen til en populasjonsutvikling ved f√∏rst √• modellere forholdet mellom total populasjon og √•r (for hver lokalitet og for hver region), ved √• bruke en bayesiansk regresjonsmodell. Etter √• ha kj√∏rt hver modell beregnet vi sannsynligheten for retning, dvs. stigningstallet for regresjonslinjen mellom populasjonsst√∏rrelse og √•r, alts√• populasjonstrenden. 

Sannsynligheten for at stigningstallet er negativt (alts√• at populasjonsutviklingen er nedadg√•ende) er vist i r√∏dt, mens sannsynligheten for at stigningstallet er positivt (alts√• at populasjonen er √∏kende) er vist i bl√•tt. 
...
![](data/derived_data/direction_plots/plots/EkebergskrÂningen.png)

![](data/derived_data/direction_plots/plots/Heggholmen.png)

![](data/derived_data/direction_plots/plots/Horgen.png)

![](data/derived_data/direction_plots/plots/Hoved¯ya V.png)

![](data/derived_data/direction_plots/plots/Hoved¯ya.png)

![](data/derived_data/direction_plots/plots/Kalv¯ya.png)

![](data/derived_data/direction_plots/plots/M¯llerenga.png)

![](data/derived_data/direction_plots/plots/Spireodden.png)

![](data/derived_data/direction_plots/plots/Stor¯ykilen.png)
...
![](data/derived_data/direction_plots/plots/Haugsbygd, vestvendt vegskrÂning.png)

![](data/derived_data/direction_plots/plots/HurumÂsen.png)

![](data/derived_data/direction_plots/plots/Nordre Ultvet.png)

![](data/derived_data/direction_plots/plots/Ultvet S¯.png)

![](data/derived_data/direction_plots/plots/≈saporten N¯.png)
