...
data3 |> 
  ...
  labs(x="Ar", y="oppsummert vekstrate (95% CI)")+
  theme_classic()+
  ggtitle("Summary weighted growth rate for all locations combined")
...
R_data|> 
  ...
  labs(x="Ar", y="oppsummert vekstrate (95% CI)")+
  theme_classic()+
  ggtitle("Summary weighted growth rate for each region")
...
RNT_data|> 
  ...
  labs(x="Ar", y="oppsummert vekstrate (95% CI)")+
  theme_classic()+
  ggtitle("Summary weighted growth rate for each naturtype")
