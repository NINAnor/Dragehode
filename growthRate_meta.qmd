...
data3 |> 
  filter(type=="summary") |> 
  ggplot(aes(year,y=ES,ymax=ES+(1.96*SE),ymin=ES-(1.96*SE) ))+
  geom_pointrange()+
  geom_hline(yintercept=1, lty=2,linewidth=1)+
  labs(x="Ar", y="vektet vekstrate (95% CI)")+
  theme_classic()+
...
R_data|> 
  ...
  ggplot(aes(year2,y=ES,ymax=ES+(1.96*SE),ymin=ES-(1.96*SE), group=site, colour=site ))+
  geom_pointrange()+
