...
## could we also make these plots only including the populations that also have plot data in 2023, i.e. 
## Spireodden, Ekebergskråningen, Hovedøya, Hovedøya V, Horgen for Oslo
## Buss-stopp, Nordre Ultvet for Ringerike
## Grindaker, Lyngstad Vestre for Hadeland?
## that would show better if trends and CIs are consistent over years. 
...
res.H_2022 <- rma(meanGR, VARGR, weights=meanTpop,subset=(Region=="Hadeland"), slab=Lokalitet, data=testmeta_2022)
...
res.R_2022 <- rma(meanGR, VARGR, weights=meanTpop,subset=(Region=="Ringerike"), slab=Lokalitet, data=testmeta_2022)
...
res.O_2022 <- rma(meanGR, VARGR, weights=meanTpop,subset=(Region=="Oslo"), slab=Lokalitet, data=testmeta_2022)
...
R_data<-rbind(data.frame(ES=c(out_2018$yi,out_2019$yi,out_2020$yi,out_2021$yi, out_2022$yi),
                         SE=c(sqrt(out_2018$vi),sqrt(out_2019$vi),sqrt(out_2020$vi),sqrt(out_2021$vi),sqrt(out_2022$vi)), type="Region", site=c(dat.comp_2018$meta, dat.comp_2019$meta, dat.comp_2020$meta, dat.comp_2021$meta, dat.comp_2022$meta), year=c(2018,2019,2020,2021,2022)), data.frame(ES=c(out_2018$b, out_2019$b,out_2020$b, out_2021$b, out_2022$b),SE=c(out_2018$se, out_2019$se, out_2020$se, out_2021$se, out_2022$se),type="summary",site="summary", year=c(2018,2019,2020,2021,2022)))
